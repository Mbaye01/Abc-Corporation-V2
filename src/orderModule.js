...
const purchaseOrdersModule = {
  async getAll() {
    try {
      ...
      throw new Error(
        "Unable to retrieve purchase orders. Please try again later."
      );
    }
  },
  ...
  async create(data) {
    try {
      ...
      const [customerRows] = await cnx.query(
      ...
      throw new Error(
        "Unable to create purchase order. Please check your input and try again."
      );
    }
  },
  ...
  async addOrderDetail(orderDetail) {
    try {
      ...
      throw new Error(
        "Unable to add order detail. Please check your input and try again."
      );
    }
  },
  ...
  async update(id, order) {
    ...
    try {
      ...
      const { date, customer_id, delivery_address, track_number, status } =
        order;
      ...
      throw new Error(
        `Unable to update purchase order with ID ${id}. Please check your input.`
      );
    } finally {
  ...
  async getOrderDetails(orderId) {
    try {
      ...
      console.error(
        `Error retrieving order details for order ID ${orderId}:`,
        error
      );
      throw new Error(
        `Unable to retrieve order details for order ID ${orderId}.`
      );
    }
  },
  ...
  async updateOrderDetail(detailId, data) {
    try {
      ...
      throw new Error(
        `Unable to update order detail with ID ${detailId}. Please check your input.`
      );
    }
  },
